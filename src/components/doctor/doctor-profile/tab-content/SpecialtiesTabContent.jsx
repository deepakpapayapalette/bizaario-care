...
const SpecialtiesTabContent = ({ doctorData }) => {
  // Use dynamic specialties from doctorData or fallback to static data
  const specialties = doctorData?.specialties || medicalSpecialties;
