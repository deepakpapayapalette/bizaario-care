...
import { TextField, Select, MenuItem, FormControl, Box, Avatar, Tooltip, IconButton, CircularProgress, Button, Radio, FormControlLabel, RadioGroup, FormLabel, Modal, Dialog } from '@mui/material';
import EditIcon from '@mui/icons-material/Edit';
import { __postApiData, __putApiData, __getApiData } from '@utils/api';
import Swal from 'sweetalert2';
import { Plus, Edit } from 'lucide-react';
import ProfileCard1 from '../patient-referral/ProfileCard1';
import ProfileCard2 from '../patient-referral/ProfileCard2';
...
const PatientDoctorDetails = ({ patientId }) => {
  ...
  const getall_relationship_master = async () => {
    try {
      ...
      setall_relationship_master(resp.data)
  ...
  const getall_country = async () => {
    try {
      const resp = await __postApiData('/api/v1/admin/StationList', { OrgUnitLevel: "68affb6d874340d8d79dbea4" });
      setall_country(resp.data.list);
  ...
  const [isEditPatienModal, setisEditPatienModal] = useState(false)
  ...
  return (
    <div className='mt-8 container '>
      <div>
        <div className="flex justify-end items-center space-x-4">
          ...
          <button className="flex items-center space-x-2 text-[var(--primary-color)] hover:text-blue-700 transition-colors">
            ...
            <span className="text-sm font-medium underline" onClick={() => setisEditPatienModal(true)}>Edit</span>
          </button>
        </div>
      ...
      <div>
        <Dialog
          open={isEditPatienModal}
          onClose={() => setisEditPatienModal(false)}
          fullWidth
          maxWidth={false}
          PaperProps={{
            sx: {
        ...
        >
          <section>
            ...
            <div className='flex justify-end '>
              <RxCross2 size={30} className='cursor-pointer' onClick={() => setisEditPatienModal(false)} />
            </div>
            <div >
            ...
            />
              ...
              <div className="flex justify-end gap-3 mt-4">
                <Button style={{ backgroundColor: "#52677D", fontFamily: "Lora", color: "white" }} onClick={update_patient_details}>
                  Update</Button>
              </div>
            </div>
          </section>
