...
const NewsArticleHospital = () => {
  ...
  return (
    <div className='container mt-8'>
      <div className="mb-6">
        <h3 className='md:text-4xl text-2xl mb-2 '>Enter Details for News And Articles</h3>
        <p className='text-para'>
          Add or update the required details for the news and articles to
...
export default NewsArticleHospital;
