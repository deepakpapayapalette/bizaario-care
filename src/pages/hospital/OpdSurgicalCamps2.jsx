...
const OpdSurgicalCamps2 = () => {
  ...
  useEffect(() => {
    if (EventTypeList) {
      const eventtype = EventTypeList.find(item => item.name === "OPD Camp");
      if (eventtype) {
        setState(prev =>
          prev.EventTypeId !== eventtype._id
            ? { ...prev, EventTypeId: eventtype._id }
            : prev
        );
      }
  ...
  return (
    <div className='container mt-8'>
      <div className="mb-6">
        <h3 className='md:text-4xl text-2xl mb-2 '>Enter Details for Opd/Surgical Camps</h3>
        <p className='text-para'>
          Add or update the required details for the opd/surgical camps to keep records accurate and complete.
        </p>
      </div>
      <div >
...
export default OpdSurgicalCamps2
