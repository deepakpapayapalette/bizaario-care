...
const WorkshopHospital = () => {
  ...
  useEffect(() => {
    if (EventTypeList) {
      const eventtype = EventTypeList.find(item => item.name === "Workshop");
      if (eventtype) {
        setState(prev =>
  ...
  return (
    <div className='container mt-8'>
      <div className="mb-6">
        <h3 className='md:text-4xl text-2xl mb-2 '>Enter Details for Workshop</h3>
        <p className='text-para'>
          Add or update the required details for the patient testimonials to keep records accurate and complete.
        </p>
      </div>
...
export default WorkshopHospital
