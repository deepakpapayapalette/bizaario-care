...
const PatientTestimonials2 = () => {
    ...
    const initializeDropdowns = async () => {
      try {
        ...
        const digitalCMEOption = contentTypeData.find(
          (item) => item.name === "Patient Testimonials"
        );
  ...
  return (
    <div className='container mt-8'>
      <div className="mb-6">
        <h3 className='md:text-4xl text-2xl mb-2 '>Enter Details for Patient Testimonials</h3>
...
export default PatientTestimonials2
