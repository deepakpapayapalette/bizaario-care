  ...
  return (
    <div className='container mt-8'>
      <div className='mb-6'>
        ...
        <h2 className='md:text-4xl text-2xl mb-2 '>Enter Details for Digital CME</h2>
        <p className='text-para'>Add or update the required details for the digital cme to keep records accurate and complete.</p>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <FormControl fullWidth>
              ...
              <Select
                ...
                // readOnly
                labelId="asset-label"
                value={AssetId || "doctor"}
                onChange={handleChange}
                displayEmpty
                renderValue={(selected) => {
                  if (!selected) {
                    return <span style={{ color: "#9ca3af" }}>Asset</span>;
                  }
            ...
            <FormControl fullWidth>
              ...
              <Select
                ...
                displayEmpty
                renderValue={(selected) => {
                  console.log(ContentPriority, "Content Priority");
                  if (!selected) {
                    return (
                      <span style={{ color: "#9ca3af" }}>Content Type</span>
                    ); // grey placeholder
