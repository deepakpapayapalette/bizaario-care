import { TextField, Select, MenuItem, FormControl, Box, Avatar, Tooltip, IconButton, Paper, Button, Radio, FormControlLabel, RadioGroup, FormLabel } from '@mui/material';
import EditIcon from '@mui/icons-material/Edit';

import Swal from 'sweetalert2';
import { Plus, Edit } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { __postApiData, __getApiData, __putApiData } from "@utils/api";
...
const AddNewPatient = () => {
  ...
  const save_patient_details = async () => {
    setisloading_for(true);
    try {
      const resp = await __postApiData(`/api/v1/admin/savePatient`, patient_details,);

      console.log(resp, "save_patient_details");
      ...
      if (response_code === "200") {
        Swal.fire({
          ...
          navigate("/doctordashboard/patient-referral-home", {
            state: { patient_details: resp.data },
          });
        });
  ...
  const getall_insurance_provider = async () => {
    try {
      ...
      // console.log(resp, 'all_insurance_provider')
        ...
        <div className="main-content">
          ...
          <Paper elevation={3} sx={{ p: 2, borderRadius: 2 }}>
            ...
            <div className="flex justify-end gap-3 mt-4">
              <button className='theme-btn-fill' onClick={save_patient_details}>
